...
/**
 * 封装字符集ECI，根据ISO 18004的"扩展通道解释" 5.3.1.1
 *
...
final class CharacterSetEci extends AbstractEnum
{
     ...
     */
    private static ?array $valueToEci = null;
     ...
     * 通过值获取字符集ECI
     *
     * 返回给定值的代表ECI，如果合法但不支持则返回null
     *
     * @throws InvalidArgumentException 如果值不在0到900之间
     */
    public static function getCharacterSetEciByValue(int $value) : ?self
    {
        ...
        return $valueToEci[$value] ?? null;
    }

    /**
     * 通过名称返回字符集ECI
     *
     * 返回给定名称的代表ECI，如果合法但不支持则返回null
     */
