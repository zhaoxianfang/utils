...
class JS extends Minify
{
     ...
     * Will be loaded from ./dict/js/keywords_reserved.txt.
     *
     ...
     *
     * Will be loaded from ./dict/js/keywords_before.txt
     *
     * @var string[]
     */
     ...
     *     instanceof String
     *
     * Will be loaded from ./dict/js/keywords_after.txt
     *
     * @var string[]
     */
     ...
     *
     * Will be loaded from ./dict/js/operators.txt
     *
     ...
     *
     * Will be loaded from ./dict/js/operators_before.txt
     *
     * @see https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Expressions_and_Operators
     *
     * @var string[]
     ...
     *
     * Will be loaded from ./dict/js/operators_after.txt
     *
     * @see https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Expressions_and_Operators
     *
     * @var string[]
    ...
    {
        call_user_func_array(array('\\zxf\\Utils\\Minify\\Minify', '__construct'), func_get_args());
