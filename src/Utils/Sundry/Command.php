 ...
 *
 * //实例化
 * $cmd = zxf\Utils\Sundry\Command::instance();
 *
 * // 获取所有参数值
 * $all = $cmd->all();
 *
...
class Command
{
    ...
    protected ?\zxf\Utils\Sundry\CliInput $cliInput;

    protected ?\zxf\Utils\Sundry\CliOutput $cliOutput;
    ...
    public function __construct()
    {
        ...
        if (class_exists('CliInput')) {
            $this->cliInput = new \zxf\Utils\Sundry\CliInput;
        }
        if (class_exists('CliOutput')) {
            $this->cliOutput = new \zxf\Utils\Sundry\CliOutput;
        }
