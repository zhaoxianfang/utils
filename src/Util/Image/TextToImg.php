...
class TextToImg
{
     ...
     * @throws Exception
     */
    private function transformColor(string $hexVal = '0000FF', bool $isBackground = true): static
    {
     ...
     * @return $this
     */
    private function drawText(string $text, int $angle = 0, $size = null): static
    {
        // 图片背景色
